...
import io.v6d.modules.graph.ds.EdgeDataColumn;
import io.v6d.modules.graph.ds.PropertyAdjList;
import io.v6d.modules.graph.ds.PropertyRawAdjList;
import io.v6d.modules.graph.ds.VertexDataColumn;
...
public interface ArrowFragment<OID_T> extends FFIPointer {
    ...
    int vertexLabel(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex);

    @FFINameAlias("vertex_offset")
    long vertexOffset(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex);
...
//    @CXXValue SharedPtr<ArrowTable> EdgeDataTable(int labelId);
    ...
    boolean isInnerVertex(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex);

    @FFINameAlias("IsOuterVertex")
    boolean isOuterVertex(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex);
    ...
    @CXXValue @FFITypeAlias(PROPERTY_ADJ_LIST + "<uint64_t>") PropertyAdjList<Long> getOutgoingAdjList(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int edgeLabelId);


    @FFINameAlias("GetIncomingAdjList")
    @CXXValue @FFITypeAlias(PROPERTY_ADJ_LIST + "<uint64_t>") PropertyAdjList<Long> getIncomingAdjList(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int edgeLabelId);

    @FFINameAlias("GetOutgoingRawAdjList")
    @CXXValue @FFITypeAlias(PROPERTY_RAW_ADJ_LIST + "<uint64_t>") PropertyRawAdjList<Long> getOutgoingRawAdjList(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int edgeLabelId);

    @FFINameAlias("GetIncomingRawAdjList")
    @CXXValue @FFITypeAlias(PROPERTY_RAW_ADJ_LIST + "<uint64_t>") PropertyRawAdjList<Long> getIncomingRawAdjList(@FFIConst @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int edgeLabelId);
...
//    DATA_T getData(@FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int propertyId, @FFISkip DATA_T unused);
    ...
    long getIntData(@FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int propertyId);

    @FFINameAlias("GetData<double>")
    long getDoubleData(@FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int propertyId);

    @FFINameAlias("HasChild")
    boolean hasChild(@FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex, int edgeLabelId);
    ...
    boolean gid2Vertex(Long gid, @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") @CXXReference Vertex<Long> vertex);
    ...
    OID_T getOuterVertexOid(@CXXReference @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") Vertex<Long> vertex);
