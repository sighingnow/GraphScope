...
public interface GSVertexArray<T> extends FFIPointer, CXXPointer {
    ...
    void SetValue(@CXXReference @FFITypeAlias(GRAPE_VERTEX_RANGE + "<uint64_t>") VertexRange<Long> range,
            @CXXReference T val);
    ...
    @CXXOperator("[]")
    @CXXReference
    T get(@CXXReference @FFITypeAlias(GRAPE_VERTEX + "<uint64_t>") Vertex<Long> v);
