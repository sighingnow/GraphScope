...
// import com.alibaba.grape.app.graphloader.GraphLoaderBase;
...
public class TableInfo {
  ...
  public static class TableInfoBuilder {
    ...
    public TableInfoBuilder loaderClassName(String loaderClassName) {
      table.setLoaderClass(loaderClassName);
      return this;
    }
  ...
  public TableInfo(TableInfo table) {
    ...
    this.loaderClassName = table.loaderClassName;
  }
  ...
  public Class<? extends RecordLineParser> getLoaderClass() {
    if (StringUtils.isEmpty(loaderClassName)) {
      return null;
    }
    Class<? extends RecordLineParser> res = null;
    try {
      res = (Class<? extends RecordLineParser>) Class.forName(loaderClassName);
