...
@CXXHead({ GRAPE_PARALLEL_PARALLEL_MESSAGE_MANAGER_H, ARROW_PROJECTED_FRAGMENT_H,
        GRAPE_FRAGMENT_IMMUTABLE_EDGECUT_FRAGMENT_H, GRAPE_ADJ_LIST_H, CORE_JAVA_JAVA_MESSAGES_H })
public interface ParallelMessageManager extends MessageManagerBase {
    ...
    @CXXTemplate(cxx = { GRAPE_IMMUTABLE_FRAGMENT + "<jlong,uint64_t,jlong,jdouble>", DOUBLE_MSG }, java = {
            "com.alibaba.grape.fragment.ImmutableEdgecutFragment<Long,Long,Long,Double>",
            "com.alibaba.grape.parallel.message.DoubleMsg" })
    @CXXTemplate(cxx = { GRAPE_IMMUTABLE_FRAGMENT + "<jlong,uint64_t,jlong,jdouble>", LONG_MSG }, java = {
            "com.alibaba.grape.fragment.ImmutableEdgecutFragment<Long,Long,Long,Double>",
            "com.alibaba.grape.parallel.message.LongMsg" })

    @FFINameAlias("SyncStateOnOuterVertex")
    <FRAG_T extends ImmutableEdgecutFragment, MSG_T> void syncStateOnOuterVertex(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);

    @CXXTemplate(cxx = { ARROW_PROJECTED_FRAGMENT + "<int64_t,uint64_t,double,int64_t>", DOUBLE_MSG }, java = {
            "com.alibaba.grape.fragment.ArrowProjectedFragment<Long,Long,Double,Long>",
            "com.alibaba.grape.parallel.message.DoubleMsg" })
    @CXXTemplate(cxx = { ARROW_PROJECTED_FRAGMENT + "<int64_t,uint64_t,double,int64_t>", LONG_MSG }, java = {
            "com.alibaba.grape.fragment.ArrowProjectedFragment<Long,Long,Double,Long>",
            "com.alibaba.grape.parallel.message.LongMsg" })
    @FFINameAlias("SyncStateOnOuterVertex")
    <FRAG_T extends ArrowProjectedFragment, MSG_T> void syncStateOnOuterVertex(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);
     ...
     * @param <FRAG_T>
     */
    @CXXTemplate(cxx = { GRAPE_IMMUTABLE_FRAGMENT + "<jlong,uint64_t,jlong,jdouble>" }, java = {
            "com.alibaba.grape.fragment.ImmutableEdgecutFragment<Long,Long,Long,Double>" })
    @CXXTemplate(cxx = { ARROW_PROJECTED_FRAGMENT + "<int64_t,uint64_t,double,int64_t>" }, java = {
            "com.alibaba.grape.fragment.ArrowProjectedFragment<Long,Long,Double,Long>" })
    @FFINameAlias("SyncStateOnOuterVertex")
    <FRAG_T> void syncStateOnOuterVertex(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, int channel_id);
    ...
    <FRAG_T extends ImmutableEdgecutFragment, MSG_T> void sendMsgThroughOEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);
    ...
    @CXXTemplate(cxx = { ARROW_PROJECTED_FRAGMENT + "<int64_t,uint64_t,double,int64_t>", LONG_MSG }, java = {
            ...
            "com.alibaba.grape.parallel.message.LongMsg" })
    @FFINameAlias("SendMsgThroughOEdges")
    <FRAG_T extends ArrowProjectedFragment, MSG_T> void sendMsgThroughOEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);
    ...
    <FRAG_T extends ImmutableEdgecutFragment, MSG_T> void sendMsgThroughIEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);
    ...
    @CXXTemplate(cxx = { ARROW_PROJECTED_FRAGMENT + "<int64_t,uint64_t,double,int64_t>", LONG_MSG }, java = {
            ...
            "com.alibaba.grape.parallel.message.LongMsg" })
    @FFINameAlias("SendMsgThroughIEdges")
    <FRAG_T extends ArrowProjectedFragment, MSG_T> void sendMsgThroughIEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);
    ...
    <FRAG_T extends ImmutableEdgecutFragment, MSG_T> void SendMsgThroughEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);
    ...
    @CXXTemplate(cxx = { ARROW_PROJECTED_FRAGMENT + "<int64_t,uint64_t,double,int64_t>", LONG_MSG }, java = {
            ...
            "com.alibaba.grape.parallel.message.LongMsg" })
    @FFINameAlias("SendMsgThroughEdges")
    <FRAG_T extends ArrowProjectedFragment, MSG_T> void SendMsgThroughEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, @CXXReference MSG_T msg,
            int channel_id);

    default <FRAG_T, MSG_T> void parallelProcess(FRAG_T frag, int threadNum, ExecutorService executor,
            Supplier<MSG_T> msgSupplier, BiConsumer<Vertex<Long>, MSG_T> consumer) {
    ...
    // default <FRAG_T, MSG_T, MSG_FACTORY_T> void parallelSyncStateOnOuterVertex(FRAG_T frag, VertexRange<Long>
