...
public interface VertexRange<VID> extends FFIPointer, CXXPointer, CXXValueRange<Vertex<VID>> {
    ...
    /**
     * Return the Begin vertex for this VertexRange. Note that invoking this methods multiple times will return the same
     * reference, java object is not created when this method is called.
     *
