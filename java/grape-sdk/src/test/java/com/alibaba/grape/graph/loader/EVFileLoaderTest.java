...
public class EVFileLoaderTest {
    ...
    private FFIVector.Factory longFactory = FFITypeFactory.getFactory(FFIVector.class,
            "std::vector<std::vector<jlong>>");
    private FFIVector.Factory doubleFactory = FFITypeFactory.getFactory(FFIVector.class,
            "std::vector<std::vector<jdouble>>");
    private JobConf job;
