...
public interface PropertyMessageManager extends MessageManagerBase {
    ...
    @CXXTemplate(cxx = { CppClassName.ARROW_FRAGMENT + "<int64_t>", DOUBLE_MSG }, java = {
            "io.graphscope.fragment.ArrowFragment<java.lang.Long>", "com.alibaba.grape.parallel.message.DoubleMsg" })
    @CXXTemplate(cxx = { CppClassName.ARROW_FRAGMENT + "<int64_t>", LONG_MSG }, java = {
            "io.graphscope.fragment.ArrowFragment<java.lang.Long>", "com.alibaba.grape.parallel.message.LongMsg" })
    @FFINameAlias("SendMsgThroughIEdges")
    <FRAG_T, MSG_T> void sendMsgThroughIEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, int eLabelId, @CXXReference MSG_T msg);
    ...
    <FRAG_T, MSG_T> void sendMsgThroughOEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, int eLabelId, @CXXReference MSG_T msg);
    ...
    <FRAG_T, MSG_T> void sendMsgThroughEdges(@CXXReference FRAG_T frag,
            @CXXReference @FFITypeAlias(GRAPE_LONG_VERTEX) Vertex<Long> vertex, int eLabelId, @CXXReference MSG_T msg);
    ...
    <FRAG_T, MSG_T> void syncStateOnOuterVertex(@CXXReference FRAG_T frag,
