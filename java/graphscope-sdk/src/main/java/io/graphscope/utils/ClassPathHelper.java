...
/**
 * Java 1.8 does not allow us to modify classPath at runtime, so we need another ugly way to add jar to classPath at
 * runtime.
 */
public class ClassPathHelper {
     ...
     */
    public static void addFileToClassPath(String fileName)
