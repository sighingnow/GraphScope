...
public class CPP_HEADER {
    ...
    public static final String PROPERTY_GRAPH_UTILS_H = "vineyard/graph/fragment/property_graph_utils.h";
    public static final String CORE_JAVA_TYPE_ALIAS_H = "core/java/type_alias.h";
    public static final String LABELED_VERTEX_PROPERTY_CONTEXT_H = "core/context/labeled_vertex_property_context.h";
