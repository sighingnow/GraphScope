...
public class ComfriendSterLineParser implements EVLineParserBase<Long, Long, Double> {
    @Override
    public void loadEdgeLine(String data, MutationContext<Long, Long, Double> context) throws IOException {
        ...
        context.addEdgeRequest(Long.valueOf(fields[0]), Long.valueOf(fields[1]), Double.valueOf(fields[2]));
    }
