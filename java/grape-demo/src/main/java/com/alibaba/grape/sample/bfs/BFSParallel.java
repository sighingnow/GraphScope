...
public class BFSParallel implements ParallelAppBase<Long, Long, Long, Double, BFSParallelContext> {
    ...
    public void IncEval(ImmutableEdgecutFragment<Long, Long, Long, Double> frag, ParallelContextBase context, ParallelMessageManager messageManager) {
        ...
        BiConsumer<Vertex<Long>, EmptyType> receiveMsg = (vertex, msg) -> {
        ...
        BiConsumer<Vertex<Long>, Integer> vertexProcessConsumer = (cur, finalTid) -> {
        ...
        forEachVertex(innerVertices, ctx.threadNum, ctx.executor, ctx.currentInnerUpdated, vertexProcessConsumer);
