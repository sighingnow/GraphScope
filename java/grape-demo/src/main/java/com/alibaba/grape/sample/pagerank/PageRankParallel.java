...
public class PageRankParallel extends Communicator
    ...
    public void PEval(ImmutableEdgecutFragment<Long, Long, Long, Double> frag, ParallelContextBase contextBase,
        ...
        BiConsumer<Vertex<Long>, Integer> calc = (Vertex<Long> vertex, Integer finalTid) -> {
            ...
            if (edgeNum == 0) {
                ...
                javaParallelMessageManager.sendMsgThroughOEdges(frag, vertex, msg, finalTid);
            }
        };
    ...
    public void IncEval(ImmutableEdgecutFragment<Long, Long, Long, Double> frag, ParallelContextBase contextBase,
        ...
        BiConsumer<Vertex<Long>, Integer> calc = ((vertex, finalTid) -> {
            if (ctx.degree.get(vertex) == 0) {
                ...
                DoubleMsg msg = FFITypeFactoryhelper.newDoubleMsg(ctx.nextResult.get(vertex));
                javaParallelMessageManager.sendMsgThroughOEdges(frag, vertex, msg, finalTid);
            }
        });
        forEachVertex(innerVertices, ctx.thread_num, ctx.executor, calc);

        {
            ...
            BiConsumer<Vertex<Long>, Integer> consumer = ((vertex, integer) -> {
