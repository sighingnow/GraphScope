...
#ifndef ANALYTICAL_ENGINE_CORE_WORKER_JAVA_PARALLEL_WORKER_H_
#define ANALYTICAL_ENGINE_CORE_WORKER_JAVA_PARALLEL_WORKER_H_
...
class JavaParallelWorker {
  static_assert(std::is_base_of<JavaParallelAppBase<typename APP_T::fragment_t,
                                                    typename APP_T::context_t>,
                                APP_T>::value,
                "JavaParallelWorker should work with JavaParallelApp");
