...
#ifndef ANALYTICAL_ENGINE_CORE_APP_JAVA_JAVA_DEFAULT_PROPERTY_APP_BASE_H_
#define ANALYTICAL_ENGINE_CORE_APP_JAVA_JAVA_DEFAULT_PROPERTY_APP_BASE_H_
...
class JavaDefaultPropertyAppBase {
 public:
  ...
  using message_manager_t = gs::PropertyMessageManager<FRAG_T>;

  JavaDefaultPropertyAppBase() = default;
  virtual ~JavaDefaultPropertyAppBase() = default;
...
#define INSTALL_JAVA_DEFAULT_PROPERTY_WORKER(APP_T, CONTEXT_T, FRAG_T) \
 public:                                                               \
