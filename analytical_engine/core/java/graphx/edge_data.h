...
#ifndef ANALYTICAL_ENGINE_CORE_JAVA_GRAPHX_EDGE_DATA_H
#define ANALYTICAL_ENGINE_CORE_JAVA_GRAPHX_EDGE_DATA_H
...
class EdgeData<VID_T, std::string>
 ...
 private:
  ...
  graphx::ImmutableTypedArray<std::string> edatas_accessor_;
...
class EdgeDataBuilder<VID_T, std::string> : public vineyard::ObjectBuilder {
 ...
 public:
  ...
  void Init(eid_t edge_num, std::vector<char>& edata_buffer,
    ...
    LOG(INFO) << "Init edge data, num edges: " << edge_num_;
  }
...
#endif  // ANALYTICAL_ENGINE_CORE_JAVA_GRAPHX_EDGE_DATA_H
