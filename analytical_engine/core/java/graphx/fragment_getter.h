...
#ifndef ANALYTICAL_ENGINE_CORE_JAVA_GRAPHX_FRAGMENT_GETTER_H
#define ANALYTICAL_ENGINE_CORE_JAVA_GRAPHX_FRAGMENT_GETTER_H
...
class ArrowProjectedFragmentGetter {
 ...
 public:
  ...
  std::shared_ptr<ArrowProjectedFragment<oid_t, vid_t, vdata_t, edata_t>> Get(
    ...
    LOG(INFO) << "Got global vm: " << fragmentID << " fid: " << fragment->fid()
              << " fnum: " << fragment->fnum();
    return fragment;
  }
};
...
#endif  // ANALYTICAL_ENGINE_CORE_JAVA_GRAPHX_FRAGMENT_GETTER_H
