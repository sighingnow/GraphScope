...
#ifndef ANALYTICAL_ENGINE_CORE_PARALLEL_PARALLEL_JAVA_MESSAGE_MANAGER_H_
#define ANALYTICAL_ENGINE_CORE_PARALLEL_PARALLEL_JAVA_MESSAGE_MANAGER_H_
...
namespace gs {
class ParallelJavaMessageManager : public grape::MessageManagerBase,
 ...
 public:
  ParallelJavaMessageManager() : comm_(NULL_COMM) {}
  ~ParallelJavaMessageManager() override {
    if (ValidComm(comm_)) {
      MPI_Comm_free(&comm_);
    }
  }
...
#endif  // ANALYTICAL_ENGINE_CORE_PARALLEL_PARALLEL_JAVA_MESSAGE_MANAGER_H_