...
public interface StringVEDGraphXFragmentBuilder<OID_T, VID_T, VD_T, ED_T> extends FFISerializable {

    @FFINameAlias("MySeal")
    @CXXValue StdSharedPtr<GraphXStringVEDFragment<OID_T, VID_T, VD_T, ED_T>> seal(
    ...
    interface Factory<OID_T, VID_T, VD_T, ED_T> {
        ...
        StringVEDGraphXFragmentBuilder<OID_T, VID_T, VD_T, ED_T> create(
            @CXXReference VineyardClient vineyardClient, @CXXReference GraphXVertexMap<OID_T,VID_T> vm, @CXXReference GraphXCSR<VID_T> csr, @CXXReference StringVertexData<VID_T,VD_T> vdata,@CXXReference StringEdgeData<VID_T,ED_T> edata);
