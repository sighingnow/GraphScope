...
public interface StringEDGraphXFragmentBuilder<OID_T, VID_T, VD_T, ED_T> extends FFISerializable {

    @FFINameAlias("MySeal")
    @CXXValue StdSharedPtr<GraphXStringEDFragment<OID_T, VID_T, VD_T, ED_T>> seal(
    ...
    interface Factory<OID_T, VID_T, VD_T, ED_T> {
        ...
        StringEDGraphXFragmentBuilder<OID_T, VID_T, VD_T, ED_T> create(
            @CXXReference VineyardClient vineyardClient, @CXXReference GraphXVertexMap<OID_T,VID_T> vm, @CXXReference GraphXCSR<VID_T> csr, @CXXReference VertexData<VID_T,VD_T> vdata, @CXXReference StringEdgeData<VID_T,ED_T> edata);
    }
}