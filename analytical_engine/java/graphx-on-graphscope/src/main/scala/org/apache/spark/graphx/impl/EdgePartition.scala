...
class EdgePartition[
  ...
  def getLocalSrcIds: Array[PartitionID] = localSrcIds

  def getLocalDstIds: Array[PartitionID] = localDstIds

  def getData : Array[ED] = data

  def getLocal2Global : Array[VertexId] = local2global

  def getVertexAttrs : Array[VD] = vertexAttrs
