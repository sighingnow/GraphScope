package org.apache.spark.graphx.impl.onheap
...
class OnHeapVertexRDDImpl[VD](@transient val partitionsRDD: RDD[ShippableVertexPartition[VD]],
                              val targetStorageLevel: StorageLevel = StorageLevel.MEMORY_ONLY)
                             (implicit override protected val vdTag: ClassTag[VD])
  extends GrapeVertexRDD[VD](partitionsRDD.context, List(new OneToOneDependency(partitionsRDD))) {
