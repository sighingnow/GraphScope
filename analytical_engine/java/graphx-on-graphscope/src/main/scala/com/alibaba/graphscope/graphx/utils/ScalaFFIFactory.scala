...
object ScalaFFIFactory extends Logging{
  ...
  def newEdgeDataBuilder[VD: ClassTag](client : VineyardClient, arrayBuilder : VineyardArrayBuilder[VD]) : EdgeDataBuilder[Long,VD] = synchronized{
    ...
    factory.create(client,arrayBuilder)
  }
