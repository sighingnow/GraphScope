...
object ComplexTypeTest extends Logging{
  def main(args: Array[String]): Unit = {
    ...
    log.info(s"Got vertexdata id ${vertexData.id()}, address ${vertexData.getVdataArray.getRawData}, size ${vertexData.getVdataArray.getRawDataLength}")
    val fakeVector = new FakeFFIByteVector(vertexData.getVdataArray.getRawData, vertexData.getVdataArray.getRawDataLength)
