...
import com.alibaba.graphscope.graph.AbstractDoubleEdgeManager;
...
public class GraphxDoubleDoubleEdgeManagerImpl<MSG_T> extends
    AbstractDoubleEdgeManager implements
    GraphxEdgeManager<Double, Double, MSG_T> {
    ...
    @Override
    public void init(IFragment<Long, Long, Double, Double> fragment, int numCores) {
...
//        threadNbrPos = new int[numCores];
        ...
        dstVdatas = (double[]) Array.newInstance(conf.getVdataClass(), dstOids.length);
