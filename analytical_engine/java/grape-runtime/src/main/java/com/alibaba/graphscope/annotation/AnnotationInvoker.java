...
import static com.alibaba.graphscope.utils.CppClassName.GS_STRING_EDGE_DATA;
...
@FFIGenBatch(
    value =
    {
      ...
      , @FFIGen(type = "com.alibaba.graphscope.fragment.Loader.JavaLoaderInvoker"),
          ...
          @FFIGen(type = "com.alibaba.graphscope.ds.Vertex",
                  templates =
                  {
                    @CXXTemplate(cxx = "uint64_t", java = "Long")
                    , @CXXTemplate(cxx = "uint32_t", java = "Integer")
                  }),
          @FFIGen(type = "com.alibaba.graphscope.ds.PropertyNbrUnit",
                  templates =
                  {
                    @CXXTemplate(cxx = "uint64_t", java = "Long")
                    , @CXXTemplate(cxx = "uint32_t", java = "Integer"),
          ...
          @FFIGen(type = "com.alibaba.graphscope.graphx.GraphXVertexMap",
                  templates =
                  {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t"}, java = {"Long", "Long"})
                  }),
          @FFIGen(type = "com.alibaba.graphscope.graphx.VertexData",
                  templates =
                  {
        ...
        @FFIGen(type = "com.alibaba.graphscope.fragment.GraphXStringVEDFragment",
            templates =
                {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t", "std::string", "std::string"},
                        java = {"Long", "Long", "com.alibaba.fastffi.impl.CXXStdString","com.alibaba.fastffi.impl.CXXStdString"}),
                }),
          @FFIGen(type = "com.alibaba.graphscope.fragment.GraphXFragment",
                  templates =
                  {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t", "int64_t"},
                        ...
                        @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t", "int32_t"},
                                     java = {"Long", "Long", "Long", "Integer"}),
                        @CXXTemplate(cxx = {"int64_t", "uint64_t", "int32_t", "int32_t"},
                                     java = {"Long", "Long", "Integer", "Integer"}),
                        @CXXTemplate(cxx = {"int64_t", "uint64_t", "double", "int32_t"},
                                     java = {"Long", "Long", "Double", "Integer"}),
                        @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t", "double"},
                                     java = {"Long", "Long", "Long", "Double"}),
                        @CXXTemplate(cxx = {"int64_t", "uint64_t", "int32_t", "double"},
...
//                          java = {"Long", "Long", "Long", "com.alibaba.fastffi.impl.CXXStdString"}),
                    ...
                    //                      "std::string", "int64_t"},
                    //                          java = {"Long", "Long",
                    //                          "com.alibaba.fastffi.impl.CXXStdString", "Long"}),
                    //                      @CXXTemplate(cxx = {"int64_t", "uint64_t",
                    //                      "std::string", "double"},
                    //                          java = {"Long", "Long",
                    //                          "com.alibaba.fastffi.impl.CXXStdString", "Double"}),
                  }),
          @FFIGen(type = "com.alibaba.graphscope.graphx.GraphXFragmentBuilder",
                  templates =
                  {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t", "int64_t"},
                                 java = {"Long", "Long", "Long", "Long"}),
        ...
        @FFIGen(type = "com.alibaba.graphscope.graphx.StringEDGraphXFragmentBuilder",
            templates =
                {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t", "std::string"},
                        java = {"Long", "Long", "Long", "com.alibaba.fastffi.impl.CXXStdString"}),
        ...
        @FFIGen(type = "com.alibaba.graphscope.graphx.StringVEDGraphXFragmentBuilder",
              ...
              templates =
              {
                ...
                ,
                    ...
                    @CXXTemplate(
                        ...
                        java =
                            "com.alibaba.graphscope.graphx.GraphXCSR<java.lang.Long>",
                ...
                //                  @CXXTemplate(
                //                      cxx =
                //                      "gs::GraphXFragment<int64_t,uint64_t,std::string,int32_t>",
                //                      java =
                //                          "com.alibaba.graphscope.fragment.GraphXFragment<java.lang.Long,java.lang.Long,com.alibaba.fastffi.impl.CXXStdString,java.lang.Integer>",
                //                      include = @CXXHead(CORE_JAVA_GRAPHX_GRAPHX_FRAGMENT_H)),
                //                  @CXXTemplate(
                //                      cxx =
                //                      "gs::GraphXFragment<int64_t,uint64_t,std::string,double>",
                //                      java =
          ...
          @FFIGen(type = "com.alibaba.graphscope.graphx.BasicGraphXCSRBuilder",
                  templates =
                  {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t"},
                                 java = {"Long", "Long"})
                  }),
          @FFIGen(type = "com.alibaba.graphscope.graphx.VertexDataBuilder",
                  templates =
                  {
                    @CXXTemplate(cxx = {"uint64_t", "int32_t"}, java = {"Long", "Integer"})
                    , @CXXTemplate(cxx = {"uint64_t", "int64_t"}, java = {"Long", "Long"}),
        ...
        @FFIGen(type = "com.alibaba.graphscope.graphx.EdgeDataBuilder",
          ...
          //                templates = {
          //                    @CXXTemplate(cxx = {"int64_t","uint64_t","int64_t"}, java =
          //                    {"Long","Long","Long"}),
          //                    @CXXTemplate(cxx = {"int64_t","uint64_t","double"}, java =
          //                    {"Long","Long","Double"}),
          //                    @CXXTemplate(cxx = {"int64_t","uint64_t","int32_t"}, java =
          //                    {"Long","Long","Integer"})
          //                }),
          //        @FFIGen(
          //            type = "com.alibaba.graphscope.graphx.GrapeVertexPartition",
          //            templates = {
          //                @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t"}, java = {"Long",
          //                "Long",
          //                    "Long"}),
          //                @CXXTemplate(cxx = {"int64_t", "uint64_t", "double"}, java = {"Long",
          //                "Long",
          //                    "Double"}),
          //                @CXXTemplate(cxx = {"int64_t", "uint64_t", "int32_t"}, java = {"Long",
          //                "Long",
          //                    "Integer"})
          //            }),
          //        @FFIGen(
          ...
          //                    "Integer"})
          //            }),
          @FFIGen(type = "com.alibaba.graphscope.ds.GrapeNbr",
                  templates =
                  {
                    @CXXTemplate(cxx = {"uint64_t", "double"}, java = {"Long", "Double"})
                    , @CXXTemplate(cxx = {"uint64_t", "int32_t"}, java = {"Long", "Integer"}),
          ...
          @FFIGen(type = "com.alibaba.graphscope.ds.ImmutableCSR",
                  templates =
                  {
                    @CXXTemplate(cxx = {"uint64_t", "int64_t"}, java = {"Long", "Long"})
                    , @CXXTemplate(cxx = {"uint64_t", "double"}, java = {"Long", "Double"}),
          ...
          @FFIGen(type = "com.alibaba.graphscope.ds.TypedArray",
                  templates =
                  {
                    @CXXTemplate(cxx = "int64_t", java = "Long")
                    , @CXXTemplate(cxx = "int32_t", java = "Integer"),
          ...
          @FFIGen(type = "com.alibaba.graphscope.parallel.message.PrimitiveMessage",
                  templates =
                  {
                    @CXXTemplate(cxx = "double", java = "Double")
                    , @CXXTemplate(cxx = "int64_t", java = "Long")
                  }),
          @FFIGen(type = "com.alibaba.graphscope.ds.VertexRange",
                  templates =
                  {
                    @CXXTemplate(cxx = "uint64_t", java = "Long")
                    , @CXXTemplate(cxx = "uint32_t", java = "Integer")
                  }),
          @FFIGen(type = "com.alibaba.graphscope.ds.VertexArray",
                  templates =
                  {
                    @CXXTemplate(cxx = {"uint64_t", "int64_t"}, java = {"Long", "Long"})
                    , @CXXTemplate(cxx = {"uint64_t", "int32_t"}, java = {"Long", "Integer"}),
          ...
          @FFIGen(type = "com.alibaba.graphscope.ds.GrapeAdjList",
                  templates =
                  {
                    @CXXTemplate(cxx = {"uint64_t", "double"}, java = {"Long", "Double"})
                    , @CXXTemplate(cxx = {"uint64_t", "int32_t"}, java = {"Long", "Integer"}),
          ...
          @FFIGen(type = "com.alibaba.graphscope.ds.GSVertexArray",
                  templates =
                  {
                    @CXXTemplate(cxx = "int64_t", java = "Long")
                    , @CXXTemplate(cxx = "double", java = "Double"),
                    ...
                    , @CXXTemplate(cxx = "int64_t", java = "Long"),
                        ...
                        @CXXTemplate(cxx = GS_VERTEX_ARRAY + "<double>",
                                     java = "com.alibaba.graphscope.ds.GSVertexArray"
                                         + "<Double>"),
                        @CXXTemplate(cxx = GS_VERTEX_ARRAY + "<int32_t>",
                                     java = "com.alibaba.graphscope.ds.GSVertexArray"
                                         + "<Integer>"),
                        @CXXTemplate(cxx = GS_VERTEX_ARRAY + "<int64_t>",
                                     java = "com.alibaba.graphscope.ds.GSVertexArray"
                                         + "<java.lang.Long>"),
                  }),
          @FFIGen(type = "com.alibaba.graphscope.ds.PropertyNbr",
                  templates =
                  {
                    @CXXTemplate(cxx = "uint64_t", java = "Long")
                    , @CXXTemplate(cxx = "uint32_t", java = "Integer"),
                  }),
          @FFIGen(type = "com.alibaba.graphscope.ds.PropertyAdjList",
                  templates =
                  {
                    @CXXTemplate(cxx = "uint64_t", java = "Long")
                    , @CXXTemplate(cxx = "uint32_t", java = "Integer"),
                  }),
          @FFIGen(type = "com.alibaba.graphscope.ds.PropertyRawAdjList",
                  templates =
                  {
                    @CXXTemplate(cxx = "uint64_t", java = "Long")
                    , @CXXTemplate(cxx = "uint32_t", java = "Integer"),
                  }),
          @FFIGen(type = "com.alibaba.graphscope.fragment.ArrowProjectedFragment",
                  templates =
                  {
                    @CXXTemplate(cxx = {"int64_t", "uint64_t", "int64_t", "double"},
                                 java = {"Long", "Long", "Long", "Double"})
        ...
        @FFIGen(type = "com.alibaba.graphscope.fragment.ArrowProjectedFragmentMapper",
          ...
          @FFIGen(type = "com.alibaba.graphscope.ds.ProjectedAdjList",
                  templates =
                  {
                    @CXXTemplate(cxx = {"uint64_t", "double"}, java = {"Long", "Double"})
                    , @CXXTemplate(cxx = {"uint64_t", "int64_t"}, java = {"Long", "Long"}),
          ...
          //                        @CXXTemplate(cxx = "double", java = "Double")
          //                    }),
          @FFIGen(type = "com.alibaba.graphscope.fragment.ArrowFragment",
                  templates = { @CXXTemplate(cxx = "int64_t", java = "Long") },
                  functionTemplates =
                  {
                    @FFIFunGen(name = "edgeDataColumn", parameterTypes = {"DATA_T"},
          ...
          //            @FFIGen(
          //                    type =
          //                    "com.alibaba.graphscope.context.ffi.FFILabeledVertexDataContext",
          //                    templates = {
          //                        @CXXTemplate(
          ...
          //            @FFIGen(
          //                    type =
          //                    "com.alibaba.graphscope.context.ffi.FFILabeledVertexPropertyContext",
          //                    templates = {
          //                        @CXXTemplate(
          //                                cxx = {ARROW_FRAGMENT + "<int64_t>"},
          //                                java = {
                ...
                ,
                  ...
                  @CXXTemplate(
                      ...
                      java = {
                          ...
                          "Long"}),
                  @CXXTemplate(
                      cxx = {GRAPHX_FRAGMENT + "<int64_t,uint64_t,double,std::string>", "int64_t"},
                      java = {
                          "com.alibaba.graphscope.fragment.GraphXStringEDFragment<java.lang.Long,java.lang.Long,java.lang.Double,com.alibaba.fastffi.impl.CXXStdString>",
                          "Long"}),
                  @CXXTemplate(
                      cxx = {GRAPHX_FRAGMENT + "<int64_t,uint64_t,int32_t,std::string>", "int64_t"},
                      java = {
                          ...
                          "Long"}),
                  @CXXTemplate(
                      cxx = {GRAPHX_FRAGMENT + "<int64_t,uint64_t,std::string,int32_t>", "int64_t"},
                      java = {
                  ...
                  @CXXTemplate(
                      ...
                      java = {
                          ...
                          "Long"}),
                  @CXXTemplate(
                      cxx = {GRAPHX_FRAGMENT + "<int64_t,uint64_t,std::string,std::string>", "int64_t"},
                      java = {
                          "com.alibaba.graphscope.fragment.GraphXStringVEDFragment<java.lang.Long,java.lang.Long,com.alibaba.fastffi.impl.CXXStdString,com.alibaba.fastffi.impl.CXXStdString>",
                          "Long"}),
              }),
          @FFIGen(
              ...
              functionTemplates =
              {
                @FFIFunGen(name = "sendToFragment", returnType = "void",
                           parameterTypes = {"int", "MSG_T"},
                           templates =
                           {
                             @CXXTemplate(cxx = {"std::vector<char>"},
                                          java = {"com.alibaba.graphscope.stdcxx.FFIByteVector"})
                           })
                ,
                    @FFIFunGen(
                        name = "getPureMessage", returnType = "boolean", parameterTypes = {"MSG_T"},
                        templates =
                        {
                          @CXXTemplate(cxx = {"std::vector<char>"},
                                       java = {"com.alibaba.graphscope.stdcxx.FFIByteVector"})
                    ...
                    @FFIFunGen(
                        name = "getMessageGraphX", returnType = "boolean",
...
//                                  }),
                    ...
                    @FFIFunGen(
                        ...
                        templates = {
                          @CXXTemplate(
                              cxx = {GRAPHX_FRAGMENT + "<int64_t,uint64_t,int64_t,int64_t>",
                                     "int64_t", "int64_t"},
                              java =
                                  {"com.alibaba.graphscope.fragment.GraphXFragment<java.lang.Long,java.lang.Long,java.lang.Long,java.lang.Long>",
          ...
          //                    }),
          @FFIGen(
              type = "com.alibaba.graphscope.communication.FFICommunicator", functionTemplates = {
                @FFIFunGen(
                    name = "sum", returnType = "void", parameterTypes = {"MSG_T"},
                    templates =
                    {
                      @CXXTemplate(cxx = DOUBLE_MSG,
                                   java = "com.alibaba.graphscope.parallel.message.DoubleMsg")
                      ,
                          @CXXTemplate(cxx = LONG_MSG,
                                       java = "com.alibaba.graphscope.parallel.message.LongMsg")
                    })
                ,
                    @FFIFunGen(
                        name = "min", returnType = "void", parameterTypes = {"MSG_T"},
                        templates =
                        {
                          @CXXTemplate(cxx = DOUBLE_MSG,
                                       java = "com.alibaba.graphscope.parallel.message.DoubleMsg")
                    ...
                    @FFIFunGen(
                        name = "max", returnType = "void", parameterTypes = {"MSG_T"},
                        templates =
                        {
                          @CXXTemplate(cxx = DOUBLE_MSG,
                                       java = "com.alibaba.graphscope.parallel.message.DoubleMsg")
                    ...
                    @FFIFunGen(name = "sendTo", returnType = "void",
                               parameterTypes = {"int", "MSG_T"},
                               templates =
                               {
                                 @CXXTemplate(cxx = "std::vector<char>",
                    ...
                    @FFIFunGen(name = "receiveFrom", returnType = "void",
                               parameterTypes = {"int", "MSG_T"}, templates = {
                                 @CXXTemplate(cxx = "std::vector<char>",
                                              java = "com.alibaba.graphscope.stdcxx.FFIByteVector")
                               }),
              }),
