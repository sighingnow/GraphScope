...
do
   ...
   scp ~/gs/analytical_engine/java/grape-demo/target/grape-demo-0.1.jar graphscope@${host}:~/gs/analytical_engine/java/grape-demo/target/grape-demo-0.1.jar
   ...
   scp ~/gs/analytical_engine/build/graphx_test graphscope@${host}:/home/graphscope/gs/analytical_engine/build/graphx_test
   scp ~/gs/analytical_engine/build/graphx_vertex_map_loader graphscope@${host}:/home/graphscope/gs/analytical_engine/build/graphx_vertex_map_loader
   scp ~/gs/analytical_engine/build/projected_fragment_loader graphscope@${host}:/home/graphscope/gs/analytical_engine/build/projected_fragment_loader
done
